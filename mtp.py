...
weights='/home/aibml/rokmc/yolo9/target_1280.pt'
device = torch.device('cuda')
half = True
dnn=False
data = '/home/aibml/rokmc/yolo9/data/coco.yaml'
imgsz=(640, 640)
augment = False
visualize = False
conf_thres=0.25
...
log_info_name = '/home/aibml/rokmc/yolo9/mtplog/mtp_' + start_time + '.log'
...
NM_HEALTH_ADDR = 'tcp://127.0.0.1:9999'
NM_COMMANDER_ADDR = 'tcp://127.0.0.1:54543'
#NM_COMMANDER_ADDR = 'tcp://127.0.0.1:9998'
IN_ADDR = 'tcp://192.168.0.19:5560'
OUT_ADDR = 'tcp://192.168.0.19:5558'
...
class InferenceJob(threading.Thread):
    ...
    def __init__(self, insock, outsock, controlsock, internal_cmd_sock):
        ...
        self.fire_after = -1
        self.result_send = -1
        self.orig_folder = '/home/aibml/rokmc/yolo9/target_image'
        self.save_folder = '/home/aibml/rokmc/yolo9/target_crop'
